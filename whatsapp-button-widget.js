class chattingWhatsAppBtn {
    ...
    renderButton() {
        ...
        styles.setAttribute('href', 'https://cdn.jsdelivr.net/gh/luisxciv/whatsapp-button-widget@4.1/whatsapp-button-widget.css')
            ...
            if(this.clicked){ 
                ...
                options.forEach(element => {
                    ...
                    switch(element){ 
                        ...
                        whats_icon.src = 'https://cdn.jsdelivr.net/gh/luisxciv/whatsapp-button-widget@4.1/img/whatsapp.svg'
                        ...
                        new_button.setAttribute('class', 'chatting-whatsapp__button')
                        new_button.setAttribute('style', `z-index:99;text-align:center; display: flex; align-items:center`)
                        msn_icon.src = 'https://cdn.jsdelivr.net/gh/luisxciv/whatsapp-button-widget@4.1/img/messenger.png'
                        ...
                        new_button.setAttribute('class', 'chatting-whatsapp__button')
                        new_button.setAttribute('style', `z-index:99;text-align:center; display: flex; align-items:center`)
                        insta_icon.src = 'https://cdn.jsdelivr.net/gh/luisxciv/whatsapp-button-widget@4.1/img/instragram.svg'
                        ...
                        new_button.setAttribute('class', 'chatting-whatsapp__button')
                        new_button.setAttribute('style', `z-index:99;text-align:center; display: flex; align-items:center`)
                        tele_icon.src = 'https://cdn.jsdelivr.net/gh/luisxciv/whatsapp-button-widget@4.1/img/telegram.svg'
                        ...
                        new_button.setAttribute('class', 'chatting-whatsapp__button')
                        new_button.setAttribute('style', `z-index:99;text-align:center; display: flex; align-items:center`)
                        email_icon.src = 'https://cdn.jsdelivr.net/gh/luisxciv/whatsapp-button-widget@4.1/img/email.png'
